<x-guest-layout>
    ...
    <h1 class="mb-3 text-4xl font-medium">Selamat Datang di <span class="font-semibold text-teal-800">Perpustakaan ITXPRO</span></h1>

    <h4 class="mb-2 font-medium text-gray-500">Masukin Email dan Password untuk Mengakses</h4>
